  ...
  return (
    <main className="flex">
      <div className="bg-white sm:w-60 min-h-screen w-14 transition-all border-2 border-r-slate-200 shadow-2xl ">
        <ul className="mt-4">
          <li className="hover:bg-gray-400 hover:text-white cursor-pointer sm:justify-start px-4 h-12 flex items-center">
          ...
          <li className="hover:bg-gray-400 hover:text-white cursor-pointer sm:justify-start px-4 h-12 flex items-center">
            <Link to={"/chart-map"} className="flex items-center">
              <ChartBarIcon
                className={"h-5 w-5 flex-shrink-0"}
                aria-hidden="true"
              />
